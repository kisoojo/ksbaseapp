...
import com.zenoation.library.utils.dialog.DialogUtils;
import com.zenoation.library.utils.pref.PrefUtils;

import static android.content.Intent.FLAG_ACTIVITY_CLEAR_TOP;
import static com.zenoation.library.BuildConfig.ANIM_KEY;
import static com.zenoation.library.base.BaseUtils.ANIM_BOTTOM;
import static com.zenoation.library.base.BaseUtils.ANIM_FADE;
import static com.zenoation.library.base.BaseUtils.ANIM_LEFT;
import static com.zenoation.library.base.BaseUtils.ANIM_NONE;
import static com.zenoation.library.base.BaseUtils.ANIM_NO_ANIM;
import static com.zenoation.library.base.BaseUtils.ANIM_RIGHT;
import static com.zenoation.library.base.BaseUtils.ANIM_TOP;
import static com.zenoation.library.base.BaseUtils.BUTTON_PRESS_DELAY;
import static com.zenoation.library.base.BaseUtils.FLAG_DEFAULT;
import static com.zenoation.library.base.BaseUtils.bytesToObject;
...
public abstract class BaseFragmentActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public void setContentView(@LayoutRes int layoutResID) {
        ...
        try {
            ...
            findViewById(R.id.ib_header_close).setOnClickListener(this);
        } catch (Exception e) {
            //do nothing...
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.ib_header_back) {
            onBackPressed();
        } else if (id == R.id.ib_header_close) {
            finish();
        }
    }
    ...
    protected void setHeaderBack(boolean bIsVisible) {
        try {
            findViewById(R.id.ib_header_back).setVisibility(bIsVisible ? View.VISIBLE : View.GONE);
        } catch (Exception e) {
            //do nothing...
        }
    }
    ...
    protected void setHeaderClose(boolean bIsVisible) {
        try {
            findViewById(R.id.ib_header_close).setVisibility(bIsVisible ? View.VISIBLE : View.GONE);
        } catch (Exception e) {
            //do nothing...
        }
    }
    ...
    public void setFragment(int id, Fragment fragment, boolean isBackStack) {
    ...
    public void setFragment(int id, Fragment fragment, boolean isBackStack, int anim) {
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        Bundle bundle;
        ...
        bundle.putInt(ANIM_KEY, anim);
        fragment.setArguments(bundle);
        setAnimFrag(transaction, anim);
