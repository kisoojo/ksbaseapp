...
public abstract class BaseFragment extends Fragment implements View.OnClickListener {
    ...
    protected void setHeaderView() {
        try {
            mFragmentView.findViewById(R.id.ib_header_back).setOnClickListener(this);
            mFragmentView.findViewById(R.id.ib_header_close).setOnClickListener(this);
        } catch (Exception e) {
            //do nothing...
        }
    }
    ...
    protected void setHeaderBack(boolean bIsVisible) {
        try {
            mFragmentView.findViewById(R.id.ib_header_back).setVisibility(bIsVisible ? View.VISIBLE : View.GONE);
        } catch (Exception e) {
            //do nothing...
        }
    }
    ...
    protected void setHeaderClose(boolean bIsVisible) {
        try {
            mFragmentView.findViewById(R.id.ib_header_close).setVisibility(bIsVisible ? View.VISIBLE : View.GONE);
        } catch (Exception e) {
            //do nothing...
        }
    }
