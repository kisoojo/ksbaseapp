package com.zenoation.ksbaseapp.utils;
...
*/
    ...
    public String getDateTimeString(String date, int format) {
        ...
        if (format == 1) {
            ...
            dateStr = String.format(Locale.KOREA, "%s년 %s월 %s일(%s) %s:%s", ymd[0], ymd[1], ymd[2], dowStr, his[0], his[1]);
        } else if (format == 14) {
            ...
            dateStr = String.format(Locale.KOREA, "%s년 %s월 %s일 (%s) %s시 %s분", ymd[0], ymd[1], ymd[2], dowStr, his[0], his[1]);
        } else if (format == 111) {
            dateStr = String.format(Locale.KOREA, "%s년 %s월 %s일 (%s) %s시 %s분 %s초", ymd[0], ymd[1], ymd[2], dowStr, his[0], his[1], his[2]);
        }
