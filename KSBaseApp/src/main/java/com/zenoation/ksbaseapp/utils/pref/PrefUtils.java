package com.zenoation.ksbaseapp.utils.pref;
...
public class PrefUtils {
    ...
    public void removeAllParams(Context context) {
        removeAllPushParams(context);
        remove(context, PREF_IS_FIRST);
        remove(context, PREF_REQ_INFO);
        remove(context, PREF_MEMBER_INFO);
        remove(context, PREF_IDCARD_MSG_NO_SHOW);
    }
}
