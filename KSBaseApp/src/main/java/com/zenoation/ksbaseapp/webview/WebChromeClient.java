...
public class WebChromeClient extends android.webkit.WebChromeClient {
    ...
    public boolean onCreateWindow(WebView webView, boolean isDialog, boolean isUserGesture, Message resultMsg) {
        com.zenoation.ksbaseapp.webview.WebView newWebView = new com.zenoation.ksbaseapp.webview.WebView(webView.getContext());
        ...
        ((com.zenoation.ksbaseapp.webview.WebView) webView).setWebView(newWebView);
    ...
    public void onCloseWindow(WebView window) {
        ...
        mWebView.scrollTo(WebChromeClient.ScrollX, WebChromeClient.ScrollY);
